...
class Collection(models.Model):
    ...
    @classmethod
    def get_or_create_personal_collection(cls, user):
        return cls.objects.get_or_create(user=user, agent=None)

    @classmethod
    def get_or_create_agent_collection(cls, agent):
        return cls.objects.get_or_create(agent=agent, user=None)
...
class Document(models.Model):
    ...
    def generate_brief(self):
        ...
        async_generate_document_brief.delay(self.id)
