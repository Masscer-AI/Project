...
from .views import (
    ...
    ComplianceAgentTaskView,
    ComplianceConversationView,
    LanguageModelView,
...
urlpatterns = [
    ...
    path("agent-task/compliance/", ComplianceAgentTaskView.as_view(), name="agent_task_compliance"),
    path(
        "compliance/conversation/",
        ComplianceConversationView.as_view(),
        name="compliance_conversation",
    ),
