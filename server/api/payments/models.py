...
class Subscription(models.Model):
    ...
    def get_display_monthly_price_usd(self):
        """List / negotiated price for UI: subscription contract price, else plan default."""
        if self.contract_price_usd is not None:
