...
class Token(rest_framework.authtoken.models.Token):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             ...
                             verbose_name='User')
    token_type = models.CharField(max_length=64, default='temporal', help_text=('The other choice is permanent or one_time, it does not set a expires_at to the token, login has a duration of 1 day, temporal has a duration of 10 minutes'))
